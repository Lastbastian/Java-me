		...
		for (int r = 9; r >= 0; r--)
		{
			...
			for (int c = 9; c >=0; c--)
			{
				for (int i = 0; i < boardSpaces.size(); i++)
				{
					...
					{
						System.out.println(boardSpaces.get(i).getX() + boardSpaces.get(i).getY() + " = " + hitBoard.get(i).getX() + hitBoard.get(i).getY());
...
//							hitMatch = false;
				...
				for (int i = 0; i < boardSpaces.size(); i++)
				{
					...
					{
						System.out.println(boardSpaces.get(i).getX() + missBoard.get(i).getY() + " = " + hitBoard.get(i).getX() + missBoard.get(i).getY());
